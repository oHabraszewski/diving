...
import tk.chaber.sfn2021rest.admin.AdminSocketBroker;
...
public class SocketConfig implements WebSocketConfigurer {
    ...
    @Autowired
    private AdminSocketBroker adminBroker;
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        ...
        registry.addHandler(adminBroker, ConfigVars.API_PREFIX + "/websocket/admin") //TODO: change CORS after WebSocket testing
                .setAllowedOrigins("*");
    }
}
